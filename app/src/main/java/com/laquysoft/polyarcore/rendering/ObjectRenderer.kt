...
import com.laquysoft.polyarcore.R
...
class ObjectRenderer {
    ...
    fun createOnGlThread(context: Context, objBytes: ByteArray,
                         textureBytes: ByteArray) {
        // Read the texture.
        val textureBitmap = BitmapFactory.decodeByteArray(textureBytes, 0, textureBytes.size)
        ...
        // Read the obj file.
        val objInputStream = ByteArrayInputStream(objBytes)
